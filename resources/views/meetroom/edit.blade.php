...
<body >
 ...
 <div id="contents">
    <div class="container container-fluid">       
		...
		<div class="row">				
			<div class="col-md-12">		
				<form method="post" action="/meetroom/update/{{$meetroom->id}}" class="formsubmit">
					...
					<div class="form-group">
					    <label for="email">Description</label>
						 <textarea  class="form-control" id="description" name="description" placeholder="input username">{{$meetroom->description}}</textarea> 
					</div>					
